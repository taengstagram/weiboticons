...
LEGACY_EMOJIS = {
    ...
    '[多问号]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/17/wh2_org.gif',
    '[坏笑]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/79/chn_huaixiao_org.gif',
    '[酷库熊动感]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/2d/kkxdonggan_org.gif',
    '[酷库熊亲亲]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/49/kkxqinqin_org.gif',
    '[酷库熊点头]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/df/lxhxiudada_org.gif',
    '[跳绳]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/79/ts_org.gif',
    '[抱抱]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/27/bba_org.gif',
    '[酷库熊破碎]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/06/kkxposui_org.gif',
    '[不活了]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/37/lb2_org.gif',
    '[杂技]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ec/zs_org.gif',
    '[酷库熊哈欠]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e3/kkxhaqian_org.gif',
    '[呜呜]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/55/bya_org.gif',
    '[不]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a2/bx2_org.gif',
    '[舔]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3a/chn_tian_org.gif',
    '[酷库熊what]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/96/kkxwhat_org.gif',
    '[强吻]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b1/q3_org.gif',
    '[酷库熊顶]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/93/kkxding_org.gif',
    '[酷库熊胜利]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/07/kkxshengli_org.gif',
    '[奥运金牌]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/06/lxhgold_org.gif',
    '[点]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fd/weibop_org.gif',
    '[酷库熊汗]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6f/kxhan_org.gif',
    '[酷库熊眨眼]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/54/kxzhayan_org.gif',
    '[酷库熊坏笑]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f8/kxhuaixiao_org.gif',
    '[酷库熊微笑]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c5/kxweixiao_org.gif',
    '[酷库熊委屈]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d5/kxweiqu_org.gif',
    '[酷库熊怒]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b5/kxnu_org.gif',
    '[伦敦奥火]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/5a/lundunaohuo_org.gif',
    '[酷库熊哭泣]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/db/kxkuqi_org.gif',
    '[酷库熊有好礼]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c0/kkxyouhaoli_org.gif',
    '[酷库熊转]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/2c/kkxzhuan_org.gif',
    '[奥运银牌]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/43/lxhbronze_org.gif',
    '[磕头]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6a/kt_org.gif',
    '[酷库熊囧]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/eb/kxjiong_org.gif',
    '[酷库熊鼓掌]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/7e/kkxguzhang_org.gif',
    '[奥运铜牌]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fd/lxhsilver_org.gif',
    '[眨眨眼]': 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3b/zy2_org.gif',
}
